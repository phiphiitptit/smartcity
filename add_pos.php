        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                        <?php if ($update != true and $editinfo != true) : ?>
                            <div class="btn-group mr-2">
                                <a class="btn btn-info" href="add_pos.php">
                                    Thêm Địa Điểm</a>
                            </div>
                        <?php else : ?>
                            <div class="btn-group mr-2">
                    ...
                    <form action="add_pos_post.php" method="post">
                        <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <label for="inputName">Địa Điểm</label>
                            <input type="text" class="form-control" name="address" required="required" id="inputName" value="<?php echo $name; ?>">
                        </div>
                        <?php if ($update == true) : ?>
                            <button class="btn btn-primary col-md-6" type="submit" name="update" style="background: #556B2F;">Cập nhật</button>
                        <?php else : ?>
                            <button type="submit" class="btn btn-primary col-md-6" name="save">Thêm địa điểm</button>
                        <?php endif ?>
