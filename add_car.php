        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                        <?php if ($update != true and $editinfo != true) : ?>
                            <div class="btn-group mr-2">
                                <a class="btn btn-info" href="add_car.php">
                                    Thêm Xe</a>
                            </div>
                        <?php else : ?>
                            <div class="btn-group mr-2">
                                <a class="btn btn-info" href="car_manager.php">
                                    Quay lại</a>
                            </div>
                        <?php endif ?>
                    ...
                    <form action="add_car_post.php" method="post">
                        <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <label for="inputName">Mã code</label>
                            <input type="text" class="form-control" name="code" required="required" id="inputName" value="<?php echo $code; ?>">
                        </div>

                        <div class="form-group col-md-6">
                            <label for="inputUser">Số chỗ</label>
                            <input type="text" class="form-control" id="inputUser" name="socho" required="required" value="<?php echo $socho; ?>">
                        </div>
                        <?php if ($update == true) : ?>
