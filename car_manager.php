                    ...
                    <table class="table table-striped table-sm" style="text-align: center;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $d['socho']; ?></td>
                                <td>
                                    <a class="btn btn-info" href="add_car.php?id=<?php echo $d['id']; ?>">
                                        Sửa</a>
                                    <a class="btn btn-info" href="add_car_post.php?iddelete=<?php echo $d['id']; ?>" onclick="return confirm('Bạn có chắc chắn xóa?')">
                                        Xóa</a>
                                </td>
